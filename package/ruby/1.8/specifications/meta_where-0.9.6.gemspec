...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", ".gitmodules", "CHANGELOG", "Gemfile", "LICENSE", "README.rdoc", "Rakefile", "VERSION", "lib/core_ext/hash.rb", "lib/core_ext/symbol.rb", "lib/core_ext/symbol_operators.rb", "lib/meta_where.rb", "lib/meta_where/association_reflection.rb", "lib/meta_where/builder.rb", "lib/meta_where/column.rb", "lib/meta_where/compound.rb", "lib/meta_where/condition.rb", "lib/meta_where/join_dependency.rb", "lib/meta_where/relation.rb", "lib/meta_where/utility.rb", "meta_where.gemspec", "test/fixtures/companies.yml", "test/fixtures/company.rb", "test/fixtures/data_type.rb", "test/fixtures/data_types.yml", "test/fixtures/developer.rb", "test/fixtures/developers.yml", "test/fixtures/developers_projects.yml", "test/fixtures/fixed_bid_project.rb", "test/fixtures/invalid_company.rb", "test/fixtures/invalid_developer.rb", "test/fixtures/note.rb", "test/fixtures/notes.yml", "test/fixtures/people.yml", "test/fixtures/person.rb", "test/fixtures/project.rb", "test/fixtures/projects.yml", "test/fixtures/schema.rb", "test/fixtures/time_and_materials_project.rb", "test/helper.rb", "test/test_base.rb", "test/test_relations.rb"]
